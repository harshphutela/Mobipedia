    ...
    return (
        <View style={styles.main}>
            <TouchableOpacity style={styles.touchop1}>
                ...
                <Text style={styles.boxtext3}>A Complete Wikipedia of <Text style={{color:'white', fontWeight:'bold'}}>Mobile</Text> Phones</Text>
            </TouchableOpacity>
        
            
                <Text style={styles.text4}>Click to proceed with basic instructions.</Text>    
                <TouchableOpacity onPress={()=>props.navigation.navigate('Inst1')} style={styles.clickmain}>
                    <Text style={styles.clickbyutton}>➡</Text>
                </TouchableOpacity>

                <Text style={styles.text4}>or you may skip</Text>

                <TouchableOpacity onPress={()=>props.navigation.navigate("MainHome")} style={styles.clickmain2}>
                    <Text style={styles.clickbyutton2}>SKIP</Text>
                </TouchableOpacity>



            <ImageBackground style={styles.img} source={require('../source/image/circle.png')}>
