    ...
    return (
        <ScrollView style={styles.main}>
            ...
            <View style={{ flexDirection: 'row', backgroundColor: 'white', marginTop: '4%', marginBottom: '4%' }}>
                ...
                <Text style={styles.headtext}>SE</Text>
            </View>


            <View style={{ alignSelf: 'center', marginBottom: '2%', resizeMode: 'contain' }}>
                <Image style={styles.img1} source={require('./image/SEim.jpg')} />
            </View>
            ...
            <View>
                <TouchableOpacity style={styles.topacity1} onPress={()=>Linking.openURL('https://www.apple.com/in/iphone-se/')}>
            ...
            <View>
                <TouchableOpacity style={styles.topacity2} onPress={()=>Linking.openURL('https://www.apple.com/in/shop/buy-iphone/iphone-se')}>
