    ...
    return (
        <ScrollView style={styles.main}>
            ...
            <View style={{ flexDirection: 'row', backgroundColor: 'white', marginTop: '4%', marginBottom: '4%' }}>
                ...
                <Text style={styles.headtext}>12 {'&'} 12 mini</Text>
            </View>


            <View style={{ alignSelf: 'center', marginBottom: '2%', resizeMode: 'contain' }}>
                <Image style={styles.img1} source={require('./image/12pos.png')} />
            </View>


            
            <View style={{ alignSelf: 'center', marginBottom: '2%', resizeMode: 'contain' }}>
                <Image style={styles.img2} source={require('./image/12feat.png')} />
            </View>

            <View>
                <TouchableOpacity style={styles.topacity1} onPress={()=>Linking.openURL('https://www.apple.com/in/iphone-12/key-features/')}>
            ...
            <View>
                <TouchableOpacity style={styles.topacity2} onPress={()=>Linking.openURL('https://www.apple.com/in/shop/goto/buy_iphone/iphone_12')}>
