    ...
    return (
        <ScrollView style={styles.main}>
            ...
            <View style={{ alignSelf: 'center', marginBottom: '2%', resizeMode: 'contain' }}>
                <Image style={styles.img1} source={require('./image/ip13pos.png')} />
            </View>
            ...
            <View>
                <TouchableOpacity style={styles.topacity1} onPress={()=>Linking.openURL('https://www.apple.com/in/iphone-13/key-features/')}>
            ...
            <View>
                <TouchableOpacity style={styles.topacity2} onPress={()=>Linking.openURL('https://www.apple.com/in/shop/goto/buy_iphone/iphone_13')}>
